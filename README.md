...
program for mothers transitioning into CACF. Built for the program lead to run a guided
...
- **Intake** — the program lead's intake, organised as **before / during / after the meeting**: she prefills and then verifies the pre-meeting block with the participant, works through the conversation, and codes the visit afterwards. Question wording is verbatim from her form
...
> sees an empty app, not her people.
...
From the program lead's feedback session: the budget rebuild in her wants-versus-needs layout, goal "idea"
...
See `CONTINUE.md` for what shipped in each round and what is still waiting on the program lead.
